...
<head>
    ...
    <title>Smart Perpus</title>
    <link rel="shortcut icon" type="image/png" href="../../assets/images/logos/logo uncip.png" />
            ...
            <div>
                <div class="brand-logo d-flex align-items-center justify-content-between">
                    <h4 class="text-center">
                        <img src="../../assets/images/logos/logo uncip.png" width="30" alt="" class="mb-2">
                        Smart Perpus
                    </h4>
                        ...
                        <ul class="navbar-nav flex-row ms-auto align-items-center justify-content-end">
                            <li class="nav-item dropdown">
                                <a class="nav-link nav-icon-hover" href="javascript:void(0)" id="drop2"
                                    ...
                                    <img src="../../assets/images/profile/admin-1.jpg" alt="" width="35" height="35"
